...
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
USRSC=$(wget -qO- https://raw.githubusercontent.com/angga2103/permission/main/ipmini| grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/angga2103/permission/main/ipmini| grep $ipsaya | awk '{print $3}')
TEXT="
<code>🧿───────────────────🧿</code>
